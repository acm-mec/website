...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative p-2 rounded text-ink-muted hover:text-indigo transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-indigo focus:ring-offset-1"
    >
